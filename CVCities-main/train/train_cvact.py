...
class Configuration:
    ...
    gps_dict_path: str = "/home/ubuntu/data/CVACT_val/gps_dict.pkl"  # path to pre-computed distances
    ...
    # Dataset
    data_folder = "/home/ubuntu/data/CVACT_val"
    ...
    model_path: str = "/home/ubuntu/data/CV-cities_train/cvact_val"
