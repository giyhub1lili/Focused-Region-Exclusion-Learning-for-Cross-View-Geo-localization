...
class Configuration:
    ...
    # Aggregator 聚合方法
    agg_arch = 'MixVPR'
    agg_config = {'in_channels': 768,  #384
                  'in_h': 32,  # 受输入图像尺寸的影响
                  'in_w': 32,
                  'out_channels': 1024,
                  'mix_depth': 2,
    ...
    model_path: str = "/home/ubuntu/data/CV-cities_train/university/s2d/first/weather"
...
if __name__ == '__main__':
    ...
    model = TimmModel(model_name=config.model,
                      ...
                      agg_config=config.agg_config, layer1=config.layer1,model_type='first')
    print(model)
