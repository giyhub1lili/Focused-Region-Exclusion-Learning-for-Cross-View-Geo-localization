...
class Configuration:
    ...
    gps_dict_path: str ="/home/ubuntu/CVACT/gps_dict.pkl" # path to pre-computed distances
    ...
    model_path: str = "/home/ubuntu/data/CV-cities_train/cvact/second"
...
#    #todo(这个是预训练好的模型)
    ...
    #todo(这个是要训练的模型)
    checkpoint_start="/home/ubuntu/data/CV-cities_train/cvact/second/dinov2_vitb14_MixVPR/2025-04-20_101457/weights_e33_92.7960.pth"
   #CVUSA-->CVACT
   #todo(这个是预训练好的模型)
    # checkpoint_start_ready="/home/ubuntu/data/CV-cities_train/cvusa/dinov2_vitb14_MixVPR/093227/weights_e31_99.1896.pth"
    # #todo(这个是要训练的模型)
    # checkpoint_start="/home/ubuntu/data/CV-cities_train/cvact/second/dinov2_vitb14_MixVPR/2025-04-19_053006/weights_e20_92.9986.pth"
