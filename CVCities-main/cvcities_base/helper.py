...
from cvcities_base.backbones.DINOv2_myself import DinoV2_myself
...
def get_backbone(backbone_arch='resnet50',
    ...
    #     return backbones.DinoV2_(model_name=backbone_arch, layer1=layer1, facet1=facet1, layer2=layer2, layer3=layer3, facet2=facet2, use_cls=use_cls, norm_descs=norm_descs)
        ...
        if model_type=='first':
            ...
            return DinoV2_myself(model_name=backbone_arch, layer1=layer1, use_cls=use_cls, norm_descs=norm_descs,checkpoint_start_ready=checkpoint_start_ready)
def get_aggregator(agg_arch='ConvAP', agg_config={},model_type=None,checkpoint_start_ready=None):
    ...
    if 'cosplace' in agg_arch.lower():
        ...
        return aggregators.MixVPR(model_type=model_type,checkpoint_start_ready=checkpoint_start_ready,**agg_config)
