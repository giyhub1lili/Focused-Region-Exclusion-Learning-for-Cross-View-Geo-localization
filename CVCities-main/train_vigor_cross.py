...
class Configuration:
    ...
    gps_dict_path: str = "/home/ubuntu/VIGOR/2gps_dict_cross.pkl"  # gps_dict_cross.pkl | gps_dict_same.pkl
    ...
    # Dataset
    data_folder = "/home/ubuntu/data/VIGOR"
    ...
    model_path: str = "/home/ubuntu/data/CV-cities_train/vigor_cross/second"
   ...
   #todo(这个是预训练好的模型)
    checkpoint_start_ready="/home/ubuntu/data/CV-cities_train/university/s2d/first/dinov2_vitb14_MixVPR/2026-01-29_114319/weights_end.pth"
    #todo(这个是要训练的模型)
    checkpoint_start="/home/ubuntu/data/CV-cities_train/university/s2d/second/dinov2_vitb14_MixVPR/2026-01-31_110033/weights_e3_0.9815.pth"
    num_workers: int = 4
